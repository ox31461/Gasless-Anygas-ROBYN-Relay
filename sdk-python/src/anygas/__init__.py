...
class AnyGas:
    ...
    def quote(self, src_chain: int, dst_chain: int, amount_usd: float, **kw: Any) -> dict:
        return self._post("/api/route/quote", {"srcChain": src_chain, "dstChain": dst_chain,
                                               "amountUsd": amount_usd, **kw})
